...
[Coeff12, LogLikeli12, Errors12, SEReg12, Diag12, VCVrob12, VCV12, Likeli12, Scores12] = armaxfilter(logreturns,1,1,2);
error=Errors12.^2;
derror=diff(error)
for i = 1:pend
       if i==1
   ...
   for j = 1:qend
     ...
     [Coeff, LogLikeli, Errors, SEReg, Diag, VCVrob, VCV, Likeli, Scores] = armaxfilter(derror,1,p,q);
     AIC(i,j) = Diag.AIC;
   end
 clear q
end
